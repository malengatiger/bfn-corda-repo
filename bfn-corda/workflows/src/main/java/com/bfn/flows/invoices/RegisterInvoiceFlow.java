...
public class RegisterInvoiceFlow extends FlowLogic<SignedTransaction> {
    ...
    public RegisterInvoiceFlow(InvoiceState invoiceState) {
        ...
        logger.info("\uD83C\uDF3A \uD83C\uDF3A RegisterInvoiceFlow constructor with invoiceState: \uD83C\uDF4F " + invoiceState.getSupplier().getName().toString());
    }
    ...
    public SignedTransaction call() throws FlowException {
        ...
        logger.info(" \uD83D\uDD06 \uD83D\uDD06 \uD83D\uDD06 Notary: " + notary.getName().toString()
                + "  \uD83C\uDF4A supplierParty: " + invoiceState.getSupplier().getName().toString()
                + "  \uD83C\uDF4A customerParty: "+ invoiceState.getCustomer().getName().toString() +" \uD83C\uDF4E  invoice: "
        ...
        TransactionBuilder txBuilder = new TransactionBuilder(notary)
                ...
                .addCommand(command, invoiceState.getSupplier().getOwningKey(),  invoiceState.getCustomer().getOwningKey());
        ...
        FlowSession customerFlowSession = initiateFlow(invoiceState.getCustomer());
